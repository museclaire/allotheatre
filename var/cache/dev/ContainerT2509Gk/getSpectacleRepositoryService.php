...
// Returns the private 'App\Repository\SpectacleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SpectacleRepository.php';

return $this->privates['App\Repository\SpectacleRepository'] = new \App\Repository\SpectacleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
