...
return $this->privates['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ($this->privates['security.logout_listener.main'] ?? $this->load(__DIR__.'/getSecurity_LogoutListener_MainService.php'));
    yield 3 => ($this->privates['security.authentication.listener.form.main'] ?? $this->load(__DIR__.'/getSecurity_Authentication_Listener_Form_MainService.php'));
    yield 4 => ($this->privates['security.authentication.listener.rememberme.main'] ?? $this->load(__DIR__.'/getSecurity_Authentication_Listener_Rememberme_MainService.php'));
    yield 5 => ($this->privates['security.authentication.listener.anonymous.main'] ?? $this->load(__DIR__.'/getSecurity_Authentication_Listener_Anonymous_MainService.php'));
    yield 6 => ($this->privates['security.access_listener'] ?? $this->load(__DIR__.'/getSecurity_AccessListenerService.php'));
}, 7), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), ($this->privates['security.authentication.trust_resolver'] ?? $this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver('Symfony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken', 'Symfony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken')), $a, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(($this->services['http_kernel'] ?? $this->getHttpKernelService()), $a, 'connexion', false), NULL, NULL, ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()), false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.00qF1Z7', true, false, 'security.user.provider.concrete.main', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'remember_me', 3 => 'anonymous'), NULL));
