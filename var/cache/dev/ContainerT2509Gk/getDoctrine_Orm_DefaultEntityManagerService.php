...
$a->setNamespace('sf_orm_default_07eb7ed7d3c6c0c34192e3ef2a1b228ff270d8bdbdabc822be564be419e1ad5e');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_07eb7ed7d3c6c0c34192e3ef2a1b228ff270d8bdbdabc822be564be419e1ad5e');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_07eb7ed7d3c6c0c34192e3ef2a1b228ff270d8bdbdabc822be564be419e1ad5e');
...
}, 'App\\Repository\\SalleRepository' => function () {
    return ($this->privates['App\Repository\SalleRepository'] ?? $this->load(__DIR__.'/getSalleRepositoryService.php'));
}, 'App\\Repository\\SpectacleRepository' => function () {
    return ($this->privates['App\Repository\SpectacleRepository'] ?? $this->load(__DIR__.'/getSpectacleRepositoryService.php'));
}))));
