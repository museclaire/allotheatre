...
class __TwigTemplate_b54a43c7d93c37758205c34bfcc7b8603017218411bcdba49f11946419ac57d9 extends Twig_Template
{
    ...
    {
        $__internal_c9867d63d2dbccbb341972380c7d3859c5993043d63ef7edd5fd10d9727bbbc9 = $this->env->getExtension("Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension");
        $__internal_c9867d63d2dbccbb341972380c7d3859c5993043d63ef7edd5fd10d9727bbbc9->enter($__internal_c9867d63d2dbccbb341972380c7d3859c5993043d63ef7edd5fd10d9727bbbc9_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@WebProfiler/Profiler/toolbar_js.html.twig"));

        $__internal_7282336d79f5109dbc05a601ecb7f64a6056b6df9fdb5398edd5fd47401ba508 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_7282336d79f5109dbc05a601ecb7f64a6056b6df9fdb5398edd5fd47401ba508->enter($__internal_7282336d79f5109dbc05a601ecb7f64a6056b6df9fdb5398edd5fd47401ba508_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@WebProfiler/Profiler/toolbar_js.html.twig"));
...
<script";
    ...
    (function () {
        ...
        echo "',
            '";
        // line 10
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_wdt", array("token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 10, $this->getSourceContext()); })()))), "html", null, true);
        echo "',
            function(xhr, el) {
        ...
        echo "').style.display = 'block';
                    ...
                    document.getElementById('sfToolbarMainContent-";
        // line 31
        echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 31, $this->getSourceContext()); })()), "html", null, true);
        echo "').style.display = 'block';
                    document.getElementById('sfToolbarClearer-";
        // line 32
        ...
        // line 62
        echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 62, $this->getSourceContext()); })()), "html", null, true);
        echo "'), 'click', function (event) {
                    ...
                    document.getElementById('sfMiniToolbar-";
        // line 68
        echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 68, $this->getSourceContext()); })()), "html", null, true);
        echo "').style.display = 'block';
                    Sfjs.setPreference('toolbar/displayState', 'none');
                });
                Sfjs.addEventListener(document.getElementById('sfToolbarMiniToggler-";
        // line 71
        echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 71, $this->getSourceContext()); })()), "html", null, true);
        echo "'), 'click', function (event) {
                    event.preventDefault();
        ...
        echo "').style.display = 'none';
                        document.getElementById('sfToolbarClearer-";
        // line 77
        echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 77, $this->getSourceContext()); })()), "html", null, true);
        echo "').style.display = 'none';
                        elem.style.display = 'block';
                    } else {
                        document.getElementById('sfToolbarMainContent-";
        // line 80
        echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 80, $this->getSourceContext()); })()), "html", null, true);
        echo "').style.display = 'block';
                        document.getElementById('sfToolbarClearer-";
        // line 81
        ...
        // line 106
        echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 106, $this->getSourceContext()); })()), "html", null, true);
        echo "');
                    sfwdt.innerHTML = '\\
        ...
        // line 110
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_profiler", array("token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 110, $this->getSourceContext()); })()))), "html", null, true);
...
";
        ...
        $__internal_c9867d63d2dbccbb341972380c7d3859c5993043d63ef7edd5fd10d9727bbbc9->leave($__internal_c9867d63d2dbccbb341972380c7d3859c5993043d63ef7edd5fd10d9727bbbc9_prof);

        
        $__internal_7282336d79f5109dbc05a601ecb7f64a6056b6df9fdb5398edd5fd47401ba508->leave($__internal_7282336d79f5109dbc05a601ecb7f64a6056b6df9fdb5398edd5fd47401ba508_prof);
    ...
    {
        return array (  206 => 110,  199 => 106,  171 => 81,  167 => 80,  161 => 77,  157 => 76,  149 => 71,  143 => 68,  134 => 62,  102 => 33,  98 => 32,  94 => 31,  89 => 29,  85 => 28,  81 => 27,  61 => 10,  57 => 9,  47 => 6,  42 => 4,  34 => 3,  30 => 2,  25 => 1,);
    }
...
/*]]>*/</script>
", "@WebProfiler/Profiler/toolbar_js.html.twig", "/Applications/MAMP/htdocs/allotheatre/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/toolbar_js.html.twig");
    }
}
