...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\InscriptionType' => function () {
    ...
    yield 3 => ($this->privates['form.type_extension.form.data_collector'] ?? $this->load(__DIR__.'/getForm_TypeExtension_Form_DataCollectorService.php'));
